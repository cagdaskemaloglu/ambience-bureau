                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      minLength={8}
                      className="w-full border border-bureau-black px-3 py-2 pr-10 font-mono text-[12px] outline-none focus:border-bureau-amber"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(v => !v)}
                      aria-label={tr ? (showPassword ? 'Şifreyi gizle' : 'Şifreyi göster') : (showPassword ? 'Hide password' : 'Show password')}
                      className="absolute right-0 top-0 flex h-full w-9 items-center justify-center text-bureau-muted hover:text-bureau-black"
                    >
...
function EyeOffIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
      <path d="M3 3l18 18" />
      <path d="M10.6 5.1A10.9 10.9 0 0 1 12 4.5c6.5 0 10.5 7.5 10.5 7.5a17.3 17.3 0 0 1-3.4 4.3M6.6 6.6C3.7 8.3 1.5 12 1.5 12s4 7.5 10.5 7.5a10.4 10.4 0 0 0 4.6-1.1" />
